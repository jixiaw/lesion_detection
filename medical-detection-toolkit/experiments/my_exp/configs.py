...
class configs(DefaultConfigs):
    ...
    def __init__(self, server_env=None):
        ...
        self.anno_file = '/home/jxw/PycharmProjects/centernet3d/results/annoation_128.json'
        self.root_dir = '/home/jxw/Downloads/mediastinal_1/annoation/'
        self.cv_file = '/home/jxw/PycharmProjects/centernet3d/results/kflod5_new.json'
    ...
    def add_mrcnn_configs(self):
        ...
        self.pool_size = (7, 7) if self.dim == 2 else (7, 7, 7)#3)
        self.mask_pool_size = (14, 14) if self.dim == 2 else (14, 14, 14)#5)
        self.mask_shape = (28, 28) if self.dim == 2 else (28, 28, 28)#10)
